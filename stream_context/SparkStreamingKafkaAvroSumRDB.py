...
if __name__ == "__main__":
    ...
    numStreams = 4
    kafkaStreams = [KafkaUtils.createStream(ssc=ssc, zkQuorum=zkQuorum, groupId="avro-topic1-consumer", keyDecoder=pyspark.streaming.kafka.utf8_decoder, valueDecoder=decoder.read_bytes, topics={topic: 1}) for _ in range (numStreams)]
